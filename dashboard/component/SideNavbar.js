...
function SideNavbar() {
  ...
  const sidebarClasses = `fixed w-64 transition-all duration-500 ease-in-out h-screen bg-white dark:bg-gray-800 shadow-sm ${
    isOpen ? "" : "md:w-64"
  }`;
  return (
    <>
      ...
      <div className={`wrapper overflow-x-hidden bg-gray-100 dark:bg-gray-900 dark:bg-opacity-40 ${isOpen ? "" : "md:w-0"}`}>
        <nav id="sidebar-menu" className={sidebarClasses}>
