...
export default function Component() {
    ...
    //
		...
		// start::Customizer Stylesheets (Only for demo purpose)
			...
			//  dropdown
			//  <i className="ltr:mr-2 rtl:ml-2 fas fa-home"></i>
                        span Dashboards
                        //  caret 
                        span.inline-block.ltr:float-right.rtl:float-left
				//  <i className="transform transition duration-300 fas fa-chevron-down" :className="{'rotate-0': selected == 1, 'ltr:-rotate-90 rtl:rotate-90': !(selected == 1) }"></i>
			//  dropdown menu
                    ...
                    //  dropdown 
                    li.relative
                    a.block.py-2.5.px-6.hover:text-indigo-500.dark:hover:text-gray-300(:className='{ \'text-indigo-500 dark:text-gray-300\': selected == 2 }', @click='selected !== 2 ? selected = 2 : selected = null', href='javascript:;')
					...
					//  <i className="mr-2 fas fa-store"></i>
                    span Ecommerce
                    //  caret 
                    | 
fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
					...
					//  <i className="transform transition duration-300 fas fa-chevron-down" :className="{'rotate-0': selected == 2, 'ltr:-rotate-90 rtl:rotate-90': !(selected == 2) }"></i>
				//  dropdown menu
                ...
                //  dropdown 
                li.relative
                a.block.py-2.5.px-6.hover:text-indigo-500.dark:hover:text-gray-300(:className='{ \'text-indigo-500 dark:text-gray-300\': selected == 3 }', @click='selected !== 3 ? selected = 3 : selected = null', href='javascript:;')
                ...
                path(d='M6.5 1A1.5 1.5 0 0 0 5 2.5V3H1.5A1.5 1.5 0 0 0 0 4.5v8A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-8A1.5 1.5 0 0 0 14.5 3H11v-.5A1.5 1.5 0 0 0 9.5 1h-3zm0 1h3a.5.5 0 0 1 .5.5V3H6v-.5a.5.5 0 0 1 .5-.5zm1.886 6.914L15 7.151V12.5a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5V7.15l6.614 1.764a1.5 1.5 0 0 0 .772 0zM1.5 4h13a.5.5 0 0 1 .5.5v1.616L8.129 7.948a.5.5 0 0 1-.258 0L1 6.116V4.5a.5.5 0 0 1 .5-.5z')
					//  <i className="mr-2 fas fa-suitcase"></i>
                span Projects
                //  caret 
                span.inline-block.ltr:float-right.rtl:float-left
                svg.transform.transition.duration-300.mt-1.5.bi.bi-chevron-down(xmlns='http://www.w3.org/2000/svg', fill='currentColor', :className='{ \'rotate-0\': selected == 3, \'ltr:-rotate-90 rtl:rotate-90\': !(selected == 3) }', width='.8rem', height='.8rem', viewBox='0 0 16 16')
                path(fill-rule='evenodd', d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z')
						//  <i className="transform transition duration-300 fas fa-chevron-down" :className="{'rotate-0': selected == 3, 'ltr:-rotate-90 rtl:rotate-90': !(selected == 3) }"></i>
				//  dropdown menu
            ...
            //  dropdown 
            li.relative
            a.block.py-2.5.px-6.hover:text-indigo-500.dark:hover:text-gray-300(:className='{ \'text-indigo-500 dark:text-gray-300\': selected == 4 }', @click='selected !== 4 ? selected = 4 : selected = null', href='javascript:;')
            ...
            //  caret 
            span.inline-block.ltr:float-right.rtl:float-left
            svg.transform.transition.duration-300.mt-1.5.bi.bi-chevron-down(xmlns='http://www.w3.org/2000/svg', fill='currentColor', :className='{ \'rotate-0\': selected == 4, \'ltr:-rotate-90 rtl:rotate-90\': !(selected == 4) }', width='.8rem', height='.8rem', viewBox='0 0 16 16')
            path(fill-rule='evenodd', d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z')
						//  <i className="transform transition duration-300 fas fa-chevron-down" :className="{'rotate-0': selected == 4, 'ltr:-rotate-90 rtl:rotate-90': !(selected == 4) }"></i >
        //  dropdown menu 
    ...
    //  caret 
    span.inline - block.ltr: float - right.rtl: float - left
    svg.transform.transition.duration - 300.mt - 1.5.bi.bi - chevron - down(xmlns = 'http://www.w3.org/2000/svg', fill = 'currentColor', : className= '{ \'rotate-0\': open, \'ltr:-rotate-90 rtl:rotate-90\': !open }', width = '.8rem', height = '.8rem', viewBox = '0 0 16 16')
    path(fill - rule='evenodd', d = 'M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z')
    //  <i className="transform transition duration-300 fas fa-chevron-down" :className="{ 'rotate-0': open, 'ltr:-rotate-90 rtl:rotate-90': !open }"></i> 
    ...
    path(d = 'M2 1a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2H2zm12 1a1 1 0 0 1 1 1v2H1V3a1 1 0 0 1 1-1h12zM1 13V6h4v8H2a1 1 0 0 1-1-1zm5 1V6h9v7a1 1 0 0 1-1 1H6z')
					//  <i className="mr-2 fas fa-window-maximize"></i> 
					span Landing page
    //  dropdown 
    li.relative
    a.block.py - 2.5.px - 6.hover: text - indigo - 500.dark: hover: text - gray - 300(: className= '{ \'text-indigo-500 dark:text-gray-300\': selected == 5 }', @click = 'selected !== 5 ? selected = 5 : selected = null', href = 'javascript:;')
    ...
    path(d = 'M3 4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V4z')
					//  <i className="mr-2 fas fa-columns"></i> 
					span Layout
    //  caret 
    span.inline - block.ltr: float - right.rtl: float - left
    svg.transform.transition.duration - 300.mt - 1.5.bi.bi - chevron - down(xmlns = 'http://www.w3.org/2000/svg', fill = 'currentColor', : className= '{ \'rotate-0\': selected == 5, \'ltr:-rotate-90 rtl:rotate-90\': !(selected == 5) }', width = '.8rem', height = '.8rem', viewBox = '0 0 16 16')
    path(fill - rule='evenodd', d = 'M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z')
    //  <i className="transform transition duration-300 fas fa-chevron-down" :className="{ 'rotate-0': selected == 5, 'ltr:-rotate-90 rtl:rotate-90': !(selected == 5) }"></i> 
    //  dropdown menu 
    ...
    //  dropdown 
    li.relative
    a.block.py - 2.5.px - 6.hover: text - indigo - 500.dark: hover: text - gray - 300(: className= '{ \'text-indigo-500 dark:text-gray-300\': selected == 6 }', @click = 'selected !== 6 ? selected = 6 : selected = null', href = 'javascript:;')
    ...
    //  caret 
    span.inline - block.ltr: float - right.rtl: float - left
    svg.transform.transition.duration - 300.mt - 1.5.bi.bi - chevron - down(xmlns = 'http://www.w3.org/2000/svg', fill = 'currentColor', : className= '{ \'rotate-0\': selected == 6, \'ltr:-rotate-90 rtl:rotate-90\': !(selected == 6) }', width = '.8rem', height = '.8rem', viewBox = '0 0 16 16')
    path(fill - rule='evenodd', d = 'M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z')
    //  <i className="transform transition duration-300 fas fa-chevron-down" :className="{ 'rotate-0': selected == 6, 'ltr:-rotate-90 rtl:rotate-90': !(selected == 6) }"></i> 
    //  dropdown menu 
    ...
    //  dropdown 
    li.relative
    a.block.py - 2.5.px - 6.hover: text - indigo - 500.dark: hover: text - gray - 300(: className= '{ \'text-indigo-500 dark:text-gray-300\': selected == 7 }', @click = 'selected !== 7 ? selected = 7 : selected = null', href = 'javascript:;')
    ...
    path(d = 'M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm-1-5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zM4 8a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm0 2.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z')
					//  <i className="mr-2 fas fa-list-alt"></i> 
					span Forms
    //  caret 
    span.inline - block.ltr: float - right.rtl: float - left
    svg.transform.transition.duration - 300.mt - 1.5.bi.bi - chevron - down(xmlns = 'http://www.w3.org/2000/svg', fill = 'currentColor', : className= '{ \'rotate-0\': selected == 7, \'ltr:-rotate-90 rtl:rotate-90\': !(selected == 7) }', width = '.8rem', height = '.8rem', viewBox = '0 0 16 16')
    path(fill - rule='evenodd', d = 'M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z')
    //  <i className="transform transition duration-300 fas fa-chevron-down" :className="{ 'rotate-0': selected == 7, 'ltr:-rotate-90 rtl:rotate-90': !(selected == 7) }"></i> 
    //  dropdown menu 
    ...
    //  dropdown 
    li.relative
    a.block.py - 2.5.px - 6.hover: text - indigo - 500.dark: hover: text - gray - 300(: className= '{ \'text-indigo-500 dark:text-gray-300\': selected == 8 }', @click = 'selected !== 8 ? selected = 8 : selected = null', href = 'javascript:;')
    ...
    //  caret 
    span.inline - block.ltr: float - right.rtl: float - left
    svg.transform.transition.duration - 300.mt - 1.5.bi.bi - chevron - down(xmlns = 'http://www.w3.org/2000/svg', fill = 'currentColor', : className= '{ \'rotate-0\': selected == 8, \'ltr:-rotate-90 rtl:rotate-90\': !(selected == 8) }', width = '.8rem', height = '.8rem', viewBox = '0 0 16 16')
    path(fill - rule='evenodd', d = 'M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z')
    //  <i className="transform transition duration-300 fas fa-chevron-down" :className="{ 'rotate-0': selected == 8, 'ltr:-rotate-90 rtl:rotate-90': !(selected == 8) }"></i> 
    //  dropdown menu 
    ...
    //  dropdown 
    li.relative
    a.block.py - 2.5.px - 6.hover: text - indigo - 500.dark: hover: text - gray - 300(: className= '{ \'text-indigo-500 dark:text-gray-300\': selected == 9 }', @click = 'selected !== 9 ? selected = 9 : selected = null', href = 'javascript:;')
    ...
    //  caret 
    span.inline - block.ltr: float - right.rtl: float - left
    svg.transform.transition.duration - 300.mt - 1.5.bi.bi - chevron - down(xmlns = 'http://www.w3.org/2000/svg', fill = 'currentColor', : className= '{ \'rotate-0\': selected == 9, \'ltr:-rotate-90 rtl:rotate-90\': !(selected == 9) }', width = '.8rem', height = '.8rem', viewBox = '0 0 16 16')
    path(fill - rule='evenodd', d = 'M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z')
    //  <i className="transform transition duration-300 fas fa-chevron-down" :className="{ 'rotate-0': selected == 9, 'ltr:-rotate-90 rtl:rotate-90': !(selected == 9) }"></i> 
    //  dropdown menu 
    ...
    //  dropdown 
    li.relative
    a.block.py - 2.5.px - 6.hover: text - indigo - 500.dark: hover: text - gray - 300(: className= '{ \'text-indigo-500 dark:text-gray-300\': selected == 10 }', @click = 'selected !== 10 ? selected = 10 : selected = null', href = 'javascript:;')
    ...
    path(fill - rule='evenodd', d = 'M4.5 11.5A.5.5 0 0 1 5 11h10a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5zm-2-4A.5.5 0 0 1 3 7h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm-2-4A.5.5 0 0 1 1 3h10a.5.5 0 0 1 0 1H1a.5.5 0 0 1-.5-.5z')
					//  <i className="mr-2 fas fa-stream"></i> 
					span Multi Level
    //  caret 
    span.inline - block.ltr: float - right.rtl: float - left
    svg.transform.transition.duration - 300.mt - 1.5.bi.bi - chevron - down(xmlns = 'http://www.w3.org/2000/svg', fill = 'currentColor', : className= '{ \'rotate-0\': selected == 10, \'ltr:-rotate-90 rtl:rotate-90\': !(selected == 10) }', width = '.8rem', height = '.8rem', viewBox = '0 0 16 16')
    path(fill - rule='evenodd', d = 'M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z')
    //  <i className="transform transition duration-300 fas fa-chevron-down" :className="{ 'rotate-0': selected == 10, 'ltr:-rotate-90 rtl:rotate-90': !(selected == 10) }"></i> 
    ...
    li.relative(x - data='{ open: false }', @keydown.escape.stop = 'open = false', @click.away = 'open = false')
						a#mobiledrop - 91.block.py - 2.5.px - 6.hover: text - indigo - 500.dark: hover: text - gray - 300(: className= '{ \'text-indigo-500\': open }', @click = 'open = !open', aria - haspopup='true', x - bind: aria - expanded='open', href = 'javascript:;')
        |
        Second Level
    ...
    li.relative(x - data='{ open: false }', @keydown.escape.stop = 'open = false', @click.away = 'open = false')
						a#mobiledrop - 92.block.py - 2.5.px - 6.hover: text - indigo - 500.dark: hover: text - gray - 300(: className= '{ \'text-indigo-500\': open }', @click = 'open = !open', aria - haspopup='true', x - bind: aria - expanded='open', href = 'javascript:;')
        |
        Third Level
    ...
    a.block.w - full.py - 2.px - 6.clear - both.whitespace - nowrap.hover: text - indigo - 500.dark: hover: text - gray - 300(href = '#') Item 1
    li.relative(x - data='{ open: false }', @keydown.escape.stop = 'open = false', @click.away = 'open = false')
								a#mobiledrop - 93.block.py - 2.5.px - 6.hover: text - indigo - 500.dark: hover: text - gray - 300(: className= '{ \'text-indigo-500\': open }', @click = 'open = !open', aria - haspopup='true', x - bind: aria - expanded='open', href = 'javascript:;')
									span Item 2
    //  caret 
    span.inline - block.ltr: float - right.rtl: float - left
    svg.transform.transition.duration - 300.mt - 1.5.bi.bi - chevron - down(xmlns = 'http://www.w3.org/2000/svg', fill = 'currentColor', : className= '{ \'rotate-0\': open, \'ltr:-rotate-90 rtl:rotate-90\': !open }', width = '.8rem', height = '.8rem', viewBox = '0 0 16 16')
    ...
    h4.font - bold.inline - block.mb - 2 Sales Report
        ...
        //  end banner 
        .flex.flex - col.ltr: ml - 64.rtl: mr - 64.min - h - screen.transition - all.duration - 500.ease -in -out(x - bind: aria - expanded='open', : className= '{ \'ltr:ml-64 ltr:-mr-64 md:ltr:ml-0 md:ltr:mr-0 rtl:mr-64 rtl:-ml-64 md:rtl:mr-0 md:rtl:ml-0\': open, \'ltr:ml-0 ltr:mr-0 md:ltr:ml-64 rtl:mr-0 rtl:ml-0 md:rtl:mr-64\': !(open) }')
    //  Navbar 
    nav.z - 50.fixed.flex.flex - row.flex - nowrap.items - center.justify - between.mt - 0.py - 2.ltr: left - 0.md: ltr: left - 64.ltr: right - 0.rtl: right - 0.md: rtl: right - 64.rtl: left - 0.px - 6.bg - white.dark: bg - gray - 800.shadow - sm.transition - all.duration - 500.ease -in -out#desktop - menu(: className= '{ \'ltr:left-64 ltr:-right-64 md:ltr:left-0 md:ltr:right-0 rtl:right-64 rtl:-left-64 md:rtl:right-0 md:rtl:left-0\': open, \'ltr:left-0 ltr:right-0 md:ltr:left-64 rtl:right-0 rtl:left-0 md:rtl:right-64\': !(open) }')
				//  sidenav button
    ...
    svg.hidden.h - 8.w - 8(x - description='Icon open', x - state: on = 'Menu open', x - state: off = 'Menu closed', : className= '{ \'block\': open, \'hidden\': !(open) }', xmlns = 'http://www.w3.org/2000/svg', fill = 'currentColor', viewBox = '0 0 16 16')
    ...
    svg.block.h - 8.w - 8(x - description='Icon closed', x - state: on = 'Menu open', x - state: off = 'Menu closed', : className= '{ \'hidden\': open, \'block\': !(open) }', xmlns = 'http://www.w3.org/2000/svg', fill = 'currentColor', viewBox = '0 0 16 16')
    ...
    path(d = 'M9.796 1.343c-.527-1.79-3.065-1.79-3.592 0l-.094.319a.873.873 0 0 1-1.255.52l-.292-.16c-1.64-.892-3.433.902-2.54 2.541l.159.292a.873.873 0 0 1-.52 1.255l-.319.094c-1.79.527-1.79 3.065 0 3.592l.319.094a.873.873 0 0 1 .52 1.255l-.16.292c-.892 1.64.901 3.434 2.541 2.54l.292-.159a.873.873 0 0 1 1.255.52l.094.319c.527 1.79 3.065 1.79 3.592 0l.094-.319a.873.873 0 0 1 1.255-.52l.292.16c1.64.893 3.434-.902 2.54-2.541l-.159-.292a.873.873 0 0 1 .52-1.255l.319-.094c1.79-.527 1.79-3.065 0-3.592l-.319-.094a.873.873 0 0 1-.52-1.255l.16-.292c.893-1.64-.902-3.433-2.541-2.54l-.292.159a.873.873 0 0 1-1.255-.52l-.094-.319zm-2.633.283c.246-.835 1.428-.835 1.674 0l.094.319a1.873 1.873 0 0 0 2.693 1.115l.291-.16c.764-.415 1.6.42 1.184 1.185l-.159.292a1.873 1.873 0 0 0 1.116 2.692l.318.094c.835.246.835 1.428 0 1.674l-.319.094a1.873 1.873 0 0 0-1.115 2.693l.16.291c.415.764-.42 1.6-1.185 1.184l-.291-.159a1.873 1.873 0 0 0-2.693 1.116l-.094.318c-.246.835-1.428.835-1.674 0l-.094-.319a1.873 1.873 0 0 0-2.692-1.115l-.292.16c-.764.415-1.6-.42-1.184-1.185l.159-.291A1.873 1.873 0 0 0 1.945 8.93l-.319-.094c-.835-.246-.835-1.428 0-1.674l.319-.094A1.873 1.873 0 0 0 3.06 4.377l-.16-.292c-.415-.764.42-1.6 1.185-1.184l.292.159a1.873 1.873 0 0 0 2.692-1.115l.094-.319z')
        //  <i className="text-2xl fas fa-cog"></i> 
        //  Right Offcanvas 
    ...
    path(d = 'M11 7.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1z')
        //  <i className="self-center fas fa-calendar"></i> 
        .flex - shrink.max - w - full.px - 2.w - 3 / 4
    ...
    path(d = 'M8.864.046C7.908-.193 7.02.53 6.956 1.466c-.072 1.051-.23 2.016-.428 2.59-.125.36-.479 1.013-1.04 1.639-.557.623-1.282 1.178-2.131 1.41C2.685 7.288 2 7.87 2 8.72v4.001c0 .845.682 1.464 1.448 1.545 1.07.114 1.564.415 2.068.723l.048.03c.272.165.578.348.97.484.397.136.861.217 1.466.217h3.5c.937 0 1.599-.477 1.934-1.064a1.86 1.86 0 0 0 .254-.912c0-.152-.023-.312-.077-.464.201-.263.38-.578.488-.901.11-.33.172-.762.004-1.149.069-.13.12-.269.159-.403.077-.27.113-.568.113-.857 0-.288-.036-.585-.113-.856a2.144 2.144 0 0 0-.138-.362 1.9 1.9 0 0 0 .234-1.734c-.206-.592-.682-1.1-1.2-1.272-.847-.282-1.803-.276-2.516-.211a9.84 9.84 0 0 0-.443.05 9.365 9.365 0 0 0-.062-4.509A1.38 1.38 0 0 0 9.125.111L8.864.046zM11.5 14.721H8c-.51 0-.863-.069-1.14-.164-.281-.097-.506-.228-.776-.393l-.04-.024c-.555-.339-1.198-.731-2.49-.868-.333-.036-.554-.29-.554-.55V8.72c0-.254.226-.543.62-.65 1.095-.3 1.977-.996 2.614-1.708.635-.71 1.064-1.475 1.238-1.978.243-.7.407-1.768.482-2.85.025-.362.36-.594.667-.518l.262.066c.16.04.258.143.288.255a8.34 8.34 0 0 1-.145 4.725.5.5 0 0 0 .595.644l.003-.001.014-.003.058-.014a8.908 8.908 0 0 1 1.036-.157c.663-.06 1.457-.054 2.11.164.175.058.45.3.57.65.107.308.087.67-.266 1.022l-.353.353.353.354c.043.043.105.141.154.315.048.167.075.37.075.581 0 .212-.027.414-.075.582-.05.174-.111.272-.154.315l-.353.353.353.354c.047.047.109.177.005.488a2.224 2.224 0 0 1-.505.805l-.353.353.353.354c.006.005.041.05.041.17a.866.866 0 0 1-.121.416c-.165.288-.503.56-1.066.56z')
        //  <i className="self-center fas fa-thumbs-up"></i> 
        .flex - shrink.max - w - full.px - 2.w - 3 / 4
    ...
    path(d = 'M5 4.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm-2 0a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z')
        //  <i className="self-center fas fa-server"></i> 
        .flex - shrink.max - w - full.px - 2.w - 3 / 4
    ...
    path(d = 'M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z')
        //  <i className="self-center fas fa-comment"></i> 
        .flex - shrink.max - w - full.px - 2.w - 3 / 4
            .text - gray - 500.text - sm.mt - 1
    ...
    path(d = 'M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z')
        //  <i className="mr-2 fas fa-question-circle"></i> 
        | Help & Support
    ...
    path(d = 'M0 2a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v3h3a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-3H2a2 2 0 0 1-2-2V2zm2-1a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h7a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H2zm7.138 9.995c.193.301.402.583.63.846-.748.575-1.673 1.001-2.768 1.292.178.217.451.635.555.867 1.125-.359 2.08-.844 2.886-1.494.777.665 1.739 1.165 2.93 1.472.133-.254.414-.673.629-.89-1.125-.253-2.057-.694-2.82-1.284.681-.747 1.222-1.651 1.621-2.757H14V8h-3v1.047h.765c-.318.844-.74 1.546-1.272 2.13a6.066 6.066 0 0 1-.415-.492 1.988 1.988 0 0 1-.94.31z')
        //  <i className="mr-2 fas fa-language"></i> 
        | Change Language
