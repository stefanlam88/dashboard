...
export default function RegisterForm(){
  ...
  style={{
    backgroundImage: 'url("images/bg1.jpg")', // Replace with your image path or URL
    backgroundRepeat: "no-repeat",
    backgroundSize: "cover",
    backgroundAttachment: "fixed"
  }}
>
  <div className="flex flex-wrap flex-row text-gray-950 ">
    ...
    <div className="flex-shrink max-w-full w-full min-h-screen sm:w-2/3 lg:w-1/2 xl:w-1/3 z-30">
      {/* login form */}
      <div className="max-w-full h-full w-full px-6 sm:px-12 bg-white dark:bg-white shadow-lg z-40">
          ...
          <div className="p-6 sm:p-8">
            <form id="login-form">
              <div className="text-center">
                <a className="py-2 text-2xl" href="#">
                  <h2 className="text-2xl font-semibold text-gray-200 px-4 max-h-9 overflow-hidden">
                    ...
                    <span className="text-black  dark:text-gray-950">
                      Taildash
                    </span>
                  </h2>
                </a>
              ...
              <div className="mb-4">
                ...
                <input
                  name="name"
                  id="inputname"
                  className="w-full leading-5 relative py-2 px-4 rounded text-gray-900 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-white dark:border-indigo-200 dark:focus:border-blue-950"
                  defaultValue=""
                  aria-label="text"
                  type="text"
                  required
              ...
              <div className="mb-4">
                ...
                <input
                  name="email"
                  id="inputemail"
                  className="w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-white dark:border-indigo-200 dark:focus:border-gray-600"
                  defaultValue=""
                  aria-label="email"
                  type="email"
                  required
              ...
              <div className="mb-4">
                <label htmlFor="inputrepeatpass" className="inline-block mb-2">
                  Repeat Password
                </label>
                <input
                  id="inputrepeatpass"
            ...
            <div className="mt-4">
              ...
              <p className="text-center mb-4">
                ...
                <a className="hover:text-indigo-500" href="/login">
                  Login
                </a>
              </p>
            </div>
