...
>
  <div className="flex flex-wrap flex-row text-white ">
    ...
    <div className="flex-shrink max-w-full w-full min-h-screen sm:w-2/3 lg:w-1/2 xl:w-1/3 z-30">
      {/* login form */}
      <div className="max-w-full h-full w-full px-6 sm:px-12 bg-white dark:bg-indigo-950 shadow-lg z-40">
            ...
            <form id="login-form">
              ...
              <div className="mb-4">
                ...
                <input
                  name="name"
                  id="inputname"
                  className="w-full leading-5 relative py-2 px-4 rounded text-gray-900 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-blue-900 dark:border-blue-900 dark:focus:border-blue-950"
                  defaultValue=""
                  aria-label="text"
                  type="text"
                  required
