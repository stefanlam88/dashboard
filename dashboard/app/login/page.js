                ...
                <div className="p-6 sm:p-8">
                  <form id="login-form">
                    ...
                    <div className="mb-6">
                      ...
                      <input
                        name="email"
                        id="inputemail"
                        className="w-full leading-5 relative py-2 px-4 rounded text-grey-950 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0dark:text-gray-300 dark:bg-white dark:border-indigo-200 dark:focus:border-gray-600"
                        defaultValue=""
                        aria-label="email"
                        type="email"
                        required
                  ...
                  <div className="mt-4">
                    ...
                    <div className="text-center mb-6 sm:space-x-4">
                      ...
                      <a
                        className="p-2 block sm:inline-block rounded lg:rounded-full leading-5 text-gray-100 bg-indigo-400 border border-indigo-400 hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0 mb-3"
                        href="#"
                      >
